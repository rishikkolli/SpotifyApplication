...
$artist = "\"" . $artistName . "\"";
$db = connect();
$serviceQuery = $db->query("SELECT DISTINCT * FROM song WHERE artist=$artist");
...
<body>
    ...
    <p style="font-size: 30px; text-align: center; font-family: 'Gloria Hallelujah', cursive; color: white; margin-top: 1%; margin-bottom: 3%;">times!</p>
</body>